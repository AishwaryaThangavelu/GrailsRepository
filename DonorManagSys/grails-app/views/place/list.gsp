	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<g:sortableColumn property="placeName" title="${message(code: 'place.placeName.label', default: 'Place Name')}" />
		...
		<g:each in="${placeInstanceList}" status="i" var="placeInstance">
			<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
				...
				<td><g:link action="show" id="${placeInstance.id}">${fieldValue(bean: placeInstance, field: "placeName")}</g:link></td>
